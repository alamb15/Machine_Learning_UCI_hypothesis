...
#Is thalach associated with whether or not a patient will be diagnosed with heart disease?
#Let's get a box plot of `thalach` based on heart disease
...
#I’d like to find out if the average thalach of a heart disease patient 
#is significantly different from the average thalach for a person without heart disease.
# I'll run a hypothesis using a simple two-sample t-test
...
# finally run a chi-square test
from scipy.stats import chi2_contingency
chi2, pval, dof, exp = chi2_contingency(Xtab)
print('p-value for chi-square test: ', pval)

#our hypothesis testing is completed and using different tests we were able to determine 
#whether or not someone is diagnosed with heart disease predicated on a significance threshold of 0.05.
